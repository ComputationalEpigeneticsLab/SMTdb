            ...
            <div class="header-area">
                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                        	<li>
                                <a class="active"  href="SearchBac.jsp">Bacteria</a>
                            </li>
                            <li>
                ...
                <div class="col-md-12 col-sm-12">
		            ...
		            <table style="margin:0 auto;">
		            	<tr> 
		            		...
		            		<td> <button class="botton-search" style="border:none;"  onclick="example('genus,Citrobacter')">Citrobacter (Genus) </button></td>
		            	</tr>
		            </table>
                </div>
            </div>
...
<div id="layer-package" style="display:none;padding: 40px;">
	...
	<script type="text/javascript" src="js/font1.js"></script>
  	...
  	<script type="text/javascript" language="javascript" src="js/page/searchBac.js"></script>
