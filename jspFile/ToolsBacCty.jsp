...
<div id="loading1">
                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu" style="width:300px;">
                            ...
                            <li>
                                <a class="active" href="ToolsBacCty.jsp">Cell types within HMAR</a>
                            </li>
                            <li>
    ...
    <section class="faq-section padding-top padding-bottom" style="margin-top:50px;">
        <div class="container">
            <div class="section-header">
                <h2 class="title titleFont1" >Tools: Cell Types Within High Microbiota Abundance Region</h2>
            </div>
            <div class="faq-wrapper"  >
                <div class="col-md-12 col-sm-12">
		            <table class="" style="width:100%;margin-top:30px;margin-left:0%;"  >
		               <tr>
		               <td style="font-size:22px; font-weight:550;width:100px;" > Cell Type  </td>
		               <td style="width:35%;"><span id="celltype_xml" style="width:100%;">  </span ></td>
		               <td style="width:20px;"></td>
		               
		               <td style="font-size:22px; font-weight:550;width:80px;" > Microbiota   </td>
		               <td style="width:22%;"><span id="xml_bac_detail" style="width:100%;">  </span ></td>
		               
		                <td style="width:20px;"></td>
		                <td style="width:140px; "><button class="btn btn-danger botton-submit" style="font-size:23px; font-weight:550;" onclick="toolsCty()"><i class="fa-solid fa-magnifying-glass-arrow-right panel-li" ></i> GO</button></td>
		               </tr>
    ...
    <section class="faq-section padding-bottom" style="margin-top:-80px;">
        ...
        <div class="faq-wrapper" style="margin-top:30px; box-shadow: rgb(221, 221, 221) 1px 1px 1px 3px; background:white; padding:20px;">
			<div class="item">
                            <h5 class="title titleFont2" id="enrich_b_h">Cell types within high Microbiota abundance regions</h5>
    ...
    <script src="js/d3.min.js" ></script>
  	...
  	<script type="text/javascript" language="javascript" src="js/page/toolsCty.js"></script>
