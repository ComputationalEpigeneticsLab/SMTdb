                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a class="active" href="SearchCancer.jsp">Cancer</a>
                            </li>
                            <li>
    ...
    <section class="faq-section padding-top padding-bottom" style="margin-top:50px;">
        <div class="container">
            <div class="section-header">
                <h2 class="title titleFont1" >Search Cancer</h2>
            </div>
            <div class="faq-wrapper"  >
                <div class="col-md-12 col-sm-12">
                	<table class=" wow fadeInUp" style="width:100%;margin-top:30px;margin-left:0%;"  >
		               <tr>
		                <td ><span><input id="datasets" name="datasets" class="input-use input2" type="search" placeholder=" e.g. BRCA  " ></span></td>
		            ...
		            <table style="margin:0 auto;">
		            	<tr> 
		            		...
		            		<td> <button class="botton-search" style="border:none;"  onclick="example('BRCA')">BRCA </button></td>
		            	</tr>
		            </table>
                </div>
            </div>
...
<div id="layer-package" style="display:none;padding: 40px;">
	...
	<script type="text/javascript" src="js/font1.js"></script>
  	...
  	<script type="text/javascript" language="javascript" src="js/page/searchCancer.js"></script>
