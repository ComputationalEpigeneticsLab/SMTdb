                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a class="active" href="SearchCelltype.jsp">Cell type</a>
                            </li>
                            <li >
            ...
            <div class="faq-wrapper"  >
                <div class="col-md-12 col-sm-12">
                	<table class=" wow fadeInUp" style="width:100%;margin-top:30px;margin-left:0%;"  >
		               <tr>
		                <td ><span><input id="datasets" name="datasets" class="input-use input2" type="search" placeholder=" e.g. B lymphocytes(B-Lym)  " ></span></td>
		            ...
		            <table style="margin:0 auto;">
		            	<tr> 
		            		...
		            		<td> <button class="botton-search" style="border:none;"  onclick="example('B lymphocytes(B-Lym)')">B lymphocytes(B-Lym) </button></td>
		            	</tr>
		            </table>
...
<div id="layer-package" style="display:none;padding: 40px;">
	...
	<script type="text/javascript" src="js/font1.js"></script>
  	...
  	<script type="text/javascript" language="javascript" src="js/page/searchCelltype.js"></script>
